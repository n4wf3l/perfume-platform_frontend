...
const Terms: React.FC = () => (
  <section className="bg-[#181818] border border-[#d4af37]/10 rounded-xl shadow-lg shadow-[#d4af37]/5 p-8 mb-12">
    ...
    <ul className="mb-4 text-gray-400">
      <li>
        <span className="text-[#d4af37] font-semibold">Éditeur :</span> Sogno
        D'Oro
      </li>
      <li>
      ...
      <li>
        <span className="text-[#d4af37] font-semibold">Plateforme :</span>{" "}
        Application sur mesure avec interface administrateur pour la gestion des
        produits et commandes.
      </li>
      <li>
        <span className="text-[#d4af37] font-semibold">Hébergement :</span>{" "}

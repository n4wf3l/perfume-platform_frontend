...
const EditCategory: React.FC = () => {
  ...
  useEffect(() => {
    const fetchCategoryData = async () => {
      try {
        ...
        // Données fictives de la catégorie
        const categoryData = {
          id: id,
          ...
          status: true,
          image: "/categories/category-" + id + ".jpg",
        };
  ...
  const cancelImageRemoval = () => {
    if (removeExistingImage) {
      ...
      // Restaurer l'aperçu de l'image existante
      setImagePreview("/categories/category-" + id + ".jpg");
      setImage(null);
    }
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (removeExistingImage) {
        categoryData.append("removeExistingImage", "true");
      }
